	...
	return (
		<div className="App">
			<button onClick={() => setOpen(true)} className="open-modal-btn">✨ Открыть окно</button>
				<div onClick={() => setOpen(false)} className={`overlay animated ${openn ? 'show' : ''}`}>
				<div className="modal">
...
export default function App() {
	...
	return (
		<Modal openn ={open} setOpen={setOpen}>
			...
			<div className="qwe">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat suscipit deserunt ea nulla nesciunt facilis laudantium expedita nisi dolor iste!</div>
		</Modal>
	);
}
